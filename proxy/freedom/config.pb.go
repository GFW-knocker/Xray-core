...
type Fragment struct {
	...
	MaxSplitMin   uint64                 `protobuf:"varint,12,opt,name=max_split_min,json=maxSplitMin,proto3" json:"max_split_min,omitempty"`
	MaxSplitMax   uint64                 `protobuf:"varint,13,opt,name=max_split_max,json=maxSplitMax,proto3" json:"max_split_max,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Noise struct {
	...
	ApplyTo       string                 `protobuf:"bytes,8,opt,name=apply_to,json=applyTo,proto3" json:"apply_to,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proxy_freedom_config_proto_rawDesc = "" +
	...
	"\finterval_max\x18\x06 \x01(\x04R\vintervalMax\x12\x1b\n" +
	"\tfake_host\x18\a \x01(\bR\bfakeHost\x12!\n" +
	"\fhost1_header\x18\b \x01(\tR\vhost1Header\x12!\n" +
	"\fhost1_domain\x18\t \x01(\tR\vhost1Domain\x12!\n" +
	"\fhost2_header\x18\n" +
	" \x01(\tR\vhost2Header\x12!\n" +
	"\fhost2_domain\x18\v \x01(\tR\vhost2Domain\x12\"\n" +
	"\rmax_split_min\x18\f \x01(\x04R\vmaxSplitMin\x12\"\n" +
	"\rmax_split_max\x18\r \x01(\x04R\vmaxSplitMax\"\xec\x01\n" +
	"\x05Noise\x12\x1d\n" +
	"\n" +
	...
	"\tcount_min\x18\x06 \x01(\x04R\bcountMin\x12\x1b\n" +
	"\tcount_max\x18\a \x01(\x04R\bcountMax\x12\x19\n" +
	"\bapply_to\x18\b \x01(\tR\aapplyTo\"\x93\x03\n" +
	"\x06Config\x12P\n" +
	...
	"\x06noises\x18\a \x03(\v2\x19.xray.proxy.freedom.NoiseR\x06noises\x12(\n" +
	"\x10noise_keep_alive\x18\b \x01(\rR\x0enoiseKeepAliveB_\n" +
	"\x16com.xray.proxy.freedomP\x01Z.github.com/GFW-knocker/Xray-core/proxy/freedom\xaa\x02\x12Xray.Proxy.Freedomb\x06proto3"
