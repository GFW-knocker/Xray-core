...
import (
	geodata "github.com/GFW-knocker/Xray-core/common/geodata"
...
type Noise struct {
	...
	// GFW-knocker additions
	CountMin      uint64 `protobuf:"varint,7,opt,name=count_min,json=countMin,proto3" json:"count_min,omitempty"`
	CountMax      uint64 `protobuf:"varint,8,opt,name=count_max,json=countMax,proto3" json:"count_max,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Config struct {
	...
	// GFW-knocker addition
	NoiseKeepAlive uint32 `protobuf:"varint,9,opt,name=noise_keep_alive,json=noiseKeepAlive,proto3" json:"noise_keep_alive,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
const file_proxy_freedom_config_proto_rawDesc = "" +
	...
	"\rmax_split_max\x18\b \x01(\x04R\vmaxSplitMax\x12\x1b\n" +
	"\tfake_host\x18\t \x01(\bR\bfakeHost\x12!\n" +
	"\fhost1_header\x18\n" +
	...
	"\bapply_to\x18\x06 \x01(\tR\aapplyTo\x12\x1b\n" +
	"\tcount_min\x18\a \x01(\x04R\bcountMin\x12\x1b\n" +
	"\tcount_max\x18\b \x01(\x04R\bcountMax\"+\n" +
	"\x05Range\x12\x10\n" +
	...
	"finalRules\x12(\n" +
	"\x10noise_keep_alive\x18\t \x01(\rR\x0enoiseKeepAlive*\"\n" +
	"\n" +
	"RuleAction\x12\t\n" +
