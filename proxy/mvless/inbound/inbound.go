...
import (
	...
	"github.com/GFW-knocker/Xray-core/proxy/mvless/encryption"
...
// Handler is an inbound connection handler that handles messages in MVLess protocol.
type Handler struct {
