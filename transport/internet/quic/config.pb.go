...
const file_transport_internet_quic_config_proto_rawDesc = "" +
	"\n" +
	"$transport/internet/quic/config.proto\x12\x1cxray.transport.internet.quic\x1a!common/serial/typed_message.proto\x1a\x1dcommon/protocol/headers.proto\"\x96\x01\n" +
	"\x06Config\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12@\n" +
	"\bsecurity\x18\x02 \x01(\v2$.xray.common.protocol.SecurityConfigR\bsecurity\x128\n" +
	"\x06header\x18\x03 \x01(\v2 .xray.common.serial.TypedMessageR\x06headerB}\n" +
	" com.xray.transport.internet.quicP\x01Z8github.com/GFW-knocker/Xray-core/transport/internet/quic\xaa\x02\x1cXray.Transport.Internet.Quicb\x06proto3"
