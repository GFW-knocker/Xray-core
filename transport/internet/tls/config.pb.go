...
type Config struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// GFW-knocker: upstream retired this option; kept for backward compatibility
...
const file_transport_internet_tls_config_proto_rawDesc = "" +
	...
	"\x1fcom.xray.transport.internet.tlsP\x01Z7github.com/GFW-knocker/Xray-core/transport/internet/tls\xaa\x02\x1bXray.Transport.Internet.Tlsb\x06proto3"
