...
const file_transport_internet_headers_noop_config_proto_rawDesc = "" +
	...
	"(com.xray.transport.internet.headers.noopP\x01Z@github.com/GFW-knocker/Xray-core/transport/internet/headers/noop\xaa\x02$Xray.Transport.Internet.Headers.Noopb\x06proto3"
